    ...
    return (
        ...
        <div className="container">
            <table className='table'>
                <tr>
                    <td>Name:</td>
                    <td><input type="text" id='name' className='form-control' onChange={(e)=>NameHndl(e)} defaultValue={name}/></td>
                </tr>

                <tr>
                    <td>Email:</td>
                    <td><input type="text" id='email' className='form-control' onChange={(e)=>EmailHndl(e)} defaultValue={email}/></td>
                </tr>
